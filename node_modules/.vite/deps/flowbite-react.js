...
var AccordionComponent = ({ alwaysOpen = false, arrowIcon = HiChevronDown, children, flush = false, collapseAll = false, className, theme: customTheme = {}, ...props }) => {
  ...
  const panels = (0, import_react6.useMemo)(() => import_react6.Children.map(children, (child, i2) => (0, import_react6.cloneElement)(child, {
    alwaysOpen,
    arrowIcon,
    flush,
    isOpen: isOpen === i2,
...
var Spinner = ({ className, color = "info", light, size: size2 = "md", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime14.jsx)("span", { role: "status", ...props, children: (0, import_jsx_runtime14.jsxs)("svg", { fill: "none", viewBox: "0 0 100 101", className: (0, import_classnames11.default)(theme2.base, theme2.color[color], theme2.light[light ? "on" : "off"].base, theme2.light[light ? "on" : "off"].color[color], theme2.size[size2], className), children: [(0, import_jsx_runtime14.jsx)("path", { d: "M100 50.5908C100 78.2051 77.6142 100.591 50 100.591C22.3858 100.591 0 78.2051 0 50.5908C0 22.9766 22.3858 0.59082 50 0.59082C77.6142 0.59082 100 22.9766 100 50.5908ZM9.08144 50.5908C9.08144 73.1895 27.4013 91.5094 50 91.5094C72.5987 91.5094 90.9186 73.1895 90.9186 50.5908C90.9186 27.9921 72.5987 9.67226 50 9.67226C27.4013 9.67226 9.08144 27.9921 9.08144 50.5908Z", fill: "currentColor" }), (0, import_jsx_runtime14.jsx)("path", { d: "M93.9676 39.0409C96.393 38.4038 97.8624 35.9116 97.0079 33.5539C95.2932 28.8227 92.871 24.3692 89.8167 20.348C85.8452 15.1192 80.8826 10.7238 75.2124 7.41289C69.5422 4.10194 63.2754 1.94025 56.7698 1.05124C51.7666 0.367541 46.6976 0.446843 41.7345 1.27873C39.2613 1.69328 37.813 4.19778 38.4501 6.62326C39.0873 9.04874 41.5694 10.4717 44.0505 10.1071C47.8511 9.54855 51.7191 9.52689 55.5402 10.0491C60.8642 10.7766 65.9928 12.5457 70.6331 15.2552C75.2735 17.9648 79.3347 21.5619 82.5849 25.841C84.9175 28.9121 86.7997 32.2913 88.1811 35.8758C89.083 38.2158 91.5421 39.6781 93.9676 39.0409Z", fill: "currentFill" })] }) });
};
...
var ButtonGroup = ({ children, className, outline, pill, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime15.jsx)("div", { className: (0, import_classnames12.default)(theme2.base, className), role: "group", ...props, children: items });
};
ButtonGroup.displayName = "Button.Group";
var ButtonGroup_default = ButtonGroup;

// node_modules/flowbite-react/lib/esm/components/Button/Button.js
var ButtonComponent = (0, import_react10.forwardRef)(({ children, className, color = "info", disabled = false, fullSized, isProcessing = false, processingLabel = "Loading...", processingSpinner: SpinnerComponent = (0, import_jsx_runtime16.jsx)(Spinner, {}), gradientDuoTone, gradientMonochrome, href, label, outline = false, pill = false, positionInGroup = "none", size: size2 = "md", theme: customTheme = {}, ...props }, ref) => {
  const { buttonGroup: groupTheme, button: theme2 } = mergeDeep(useTheme().theme, customTheme);
  const isLink = typeof href !== "undefined";
  const Component = isLink ? "a" : "button";
  const theirProps = props;
  return (0, import_jsx_runtime16.jsx)(Component, { disabled, href, type: isLink ? void 0 : "button", ref, className: (0, import_classnames13.default)(disabled && theme2.disabled, !gradientDuoTone && !gradientMonochrome && theme2.color[color], gradientDuoTone && !gradientMonochrome && theme2.gradientDuoTone[gradientDuoTone], !gradientDuoTone && gradientMonochrome && theme2.gradient[gradientMonochrome], groupTheme.position[positionInGroup], outline && (theme2.outline.color[color] ?? theme2.outline.color.default), theme2.base, theme2.pill[pill ? "on" : "off"], fullSized && theme2.fullSized, className), ...theirProps, children: (0, import_jsx_runtime16.jsx)("span", { className: (0, import_classnames13.default)(theme2.inner.base, theme2.inner.position[positionInGroup], theme2.outline[outline ? "on" : "off"], theme2.outline.pill[outline && pill ? "on" : "off"], theme2.size[size2], outline && !theme2.outline.color[color] && theme2.inner.outline, isProcessing && theme2.isProcessing), children: (0, import_jsx_runtime16.jsxs)(import_jsx_runtime16.Fragment, { children: [isProcessing && (0, import_jsx_runtime16.jsx)("span", { className: theme2.spinnerSlot, children: SpinnerComponent }), typeof children !== "undefined" ? children : (0, import_jsx_runtime16.jsx)("span", { "data-testid": "flowbite-button-label", className: theme2.label, children: isProcessing ? processingLabel : label })] }) }) });
});
...
var Card = ({ children, className, horizontal, href, imgAlt, imgSrc, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime17.jsxs)(Component, { "data-testid": "flowbite-card", href, className: (0, import_classnames14.default)(theme2.root.base, theme2.root.horizontal[horizontal ? "on" : "off"], href && theme2.root.href, className), ...theirProps, children: [imgSrc && (0, import_jsx_runtime17.jsx)("img", { alt: imgAlt ?? "", src: imgSrc, className: (0, import_classnames14.default)(theme2.img.base, theme2.img.horizontal[horizontal ? "on" : "off"]) }), (0, import_jsx_runtime17.jsx)("div", { className: theme2.root.children, children })] });
};
...
var Carousel = ({ children, indicators = true, leftControl, rightControl, slide = true, slideInterval, className, theme: customTheme = {}, ...props }) => {
  ...
  const items = (0, import_react12.useMemo)(() => import_react12.Children.map(children, (child) => (0, import_react12.cloneElement)(child, {
    className: (0, import_classnames15.default)(theme2.item.base, child.props.className)
  ...
  return (0, import_jsx_runtime18.jsxs)("div", { className: (0, import_classnames15.default)(theme2.root.base, className), "data-testid": "carousel", ...props, children: [(0, import_jsx_runtime18.jsx)(index_es_default, { className: (0, import_classnames15.default)(theme2.scrollContainer.base, (isDeviceMobile || !isDragging) && theme2.scrollContainer.snap), draggingClassName: "cursor-grab", innerRef: carouselContainer, onEndScroll: handleDragging(false), onStartScroll: handleDragging(true), vertical: false, children: items == null ? void 0 : items.map((item, index3) => (0, import_jsx_runtime18.jsx)("div", { className: theme2.item.wrapper, "data-active": activeItem === index3, "data-testid": "carousel-item", children: item }, index3)) }), indicators && (0, import_jsx_runtime18.jsx)("div", { className: theme2.indicators.wrapper, children: items == null ? void 0 : items.map((_, index3) => (0, import_jsx_runtime18.jsx)("button", { className: (0, import_classnames15.default)(theme2.indicators.base, theme2.indicators.active[index3 === activeItem ? "on" : "off"]), onClick: navigateTo(index3), "data-testid": "carousel-indicator", "aria-label": `Slide ${index3 + 1}` }, index3)) }), items && (0, import_jsx_runtime18.jsxs)(import_jsx_runtime18.Fragment, { children: [(0, import_jsx_runtime18.jsx)("div", { className: theme2.root.leftControl, children: (0, import_jsx_runtime18.jsx)("button", { className: "group", "data-testid": "carousel-left-control", onClick: navigateTo(activeItem - 1), type: "button", "aria-label": "Previous slide", children: leftControl ? leftControl : (0, import_jsx_runtime18.jsx)(DefaultLeftControl, {}) }) }), (0, import_jsx_runtime18.jsx)("div", { className: theme2.root.rightControl, children: (0, import_jsx_runtime18.jsx)("button", { className: "group", "data-testid": "carousel-right-control", onClick: navigateTo(activeItem + 1), type: "button", "aria-label": "Next slide", children: rightControl ? rightControl : (0, import_jsx_runtime18.jsx)(DefaultRightControl, {}) }) })] })] });
};
...
var Checkbox = (0, import_react13.forwardRef)(({ className, theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime19.jsx)("input", { ref, type: "checkbox", className: (0, import_classnames16.default)(theme2.root.base, className), ...props });
});
...
var DarkThemeToggle = ({ className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime20.jsx)("button", { "aria-label": "Toggle dark mode", "data-testid": "dark-theme-toggle", onClick: toggleMode, type: "button", className: (0, import_classnames17.default)(theme2.root.base, className), ...props, children: mode === "dark" ? (0, import_jsx_runtime20.jsx)(HiSun, { "aria-label": "Currently dark mode", className: theme2.root.icon }) : (0, import_jsx_runtime20.jsx)(HiMoon, { "aria-label": "Currently light mode", className: theme2.root.icon }) });
};
...
var Floating = ({ animation = "duration-300", arrow: arrow3 = true, children, className, closeRequestKey, content, placement = "top", style = "dark", theme: theme2, trigger = "hover", ...props }) => {
  ...
  return (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, { children: [(0, import_jsx_runtime21.jsx)("div", { className: theme2.target, ...getReferenceProps({ ref: reference }), "data-testid": "flowbite-tooltip-target", children }), (0, import_jsx_runtime21.jsxs)("div", { "data-testid": "flowbite-tooltip", ...getFloatingProps({
    className: (0, import_classnames18.default)(theme2.base, animation && `${theme2.animation} ${animation}`, !open && theme2.hidden, theme2.style[style], className),
    ref: floating,
    style: {
      position: strategy,
      top: y ?? " ",
    ...
    ...props
  }), children: [(0, import_jsx_runtime21.jsx)("div", { className: theme2.content, children: content }), arrow3 && (0, import_jsx_runtime21.jsx)("div", { className: (0, import_classnames18.default)(theme2.arrow.base, {
...
var DropdownDivider = ({ className, ...props }) => {
  ...
  return (0, import_jsx_runtime22.jsx)("div", { className: (0, import_classnames19.default)(theme2, className), ...props });
};
...
var DropdownHeader = ({ children, className, ...props }) => {
  ...
  return (0, import_jsx_runtime23.jsxs)(import_jsx_runtime23.Fragment, { children: [(0, import_jsx_runtime23.jsx)("div", { className: (0, import_classnames20.default)(theme2, className), ...props, children }), (0, import_jsx_runtime23.jsx)(DropdownDivider, {})] });
};
...
var DropdownItem = ({ children, className, icon: Icon, onClick, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime24.jsxs)("li", { className: (0, import_classnames21.default)(theme2.base, className), onClick, ...props, children: [Icon && (0, import_jsx_runtime24.jsx)(Icon, { className: theme2.icon }), children] });
};
...
var DropdownComponent = ({ children, className, dismissOnClick = true, theme: customTheme = {}, ...props }) => {
  ...
  const content = (0, import_react20.useMemo)(() => (0, import_jsx_runtime25.jsx)("ul", { className: theme2.content, children: import_react20.Children.map(children, attachCloseListener) }), [attachCloseListener, children, theme2.content]);
  const TriggerWrapper = ({ children: children2 }) => inline2 ? (0, import_jsx_runtime25.jsx)("button", { className: theme2.inlineWrapper, children: children2 }) : (0, import_jsx_runtime25.jsx)(Button, { ...buttonProps, children: children2 });
  return (0, import_jsx_runtime25.jsx)(Floating, { content, style: "auto", animation: "duration-100", placement, arrow: floatingArrow, trigger, theme: theme2.floating, closeRequestKey, className, children: (0, import_jsx_runtime25.jsxs)(TriggerWrapper, { children: [label, arrowIcon && (0, import_jsx_runtime25.jsx)(Icon, { className: theme2.arrowIcon })] }) });
};
...
var HelperText = ({ children, className, color = "default", theme: customTheme = {}, value, ...props }) => {
  ...
  return (0, import_jsx_runtime26.jsx)("p", { className: (0, import_classnames22.default)(theme2.root.base, theme2.root.colors[color], className), ...props, children: value ?? children ?? "" });
};
...
var FileInput = (0, import_react21.forwardRef)(({ className, color = "gray", helperText, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime27.jsxs)(import_jsx_runtime27.Fragment, { children: [(0, import_jsx_runtime27.jsx)("div", { className: (0, import_classnames23.default)(theme2.root.base, className), children: (0, import_jsx_runtime27.jsx)("div", { className: theme2.field.base, children: (0, import_jsx_runtime27.jsx)("input", { className: (0, import_classnames23.default)(theme2.field.input.base, theme2.field.input.colors[color], theme2.field.input.sizes[sizing]), ...props, type: "file", ref }) }) }), helperText && (0, import_jsx_runtime27.jsx)(HelperText, { color, children: helperText })] });
});
...
var FooterBrand = ({ alt, className, children, href, name, src, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime28.jsx)("div", { children: href ? (0, import_jsx_runtime28.jsxs)("a", { "data-testid": "flowbite-footer-brand", href, className: (0, import_classnames24.default)(theme2.base, className), ...props, children: [(0, import_jsx_runtime28.jsx)("img", { alt, src, className: theme2.img }), (0, import_jsx_runtime28.jsx)("span", { "data-testid": "flowbite-footer-brand-span", className: theme2.span, children: name }), children] }) : (0, import_jsx_runtime28.jsx)("img", { alt, "data-testid": "flowbite-footer-brand", src, className: (0, import_classnames24.default)(theme2.img, className), ...props }) });
};
...
var FooterCopyright = ({ by, className, href, theme: customTheme = {}, year, ...props }) => {
  ...
  return (0, import_jsx_runtime29.jsxs)("div", { "data-testid": "flowbite-footer-copyright", className: (0, import_classnames25.default)(theme2.base, className), ...props, children: ["© ", year, href ? (0, import_jsx_runtime29.jsx)("a", { href, className: theme2.href, children: by }) : (0, import_jsx_runtime29.jsx)("span", { "data-testid": "flowbite-footer-copyright-span", className: theme2.span, children: by })] });
};
...
var FooterDivider = ({ className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime30.jsx)("hr", { "data-testid": "footer-divider", className: (0, import_classnames26.default)(theme2.base, className), ...props });
};
...
var FooterIcon = ({ ariaLabel, className, href, icon: Icon, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime31.jsx)("div", { children: href ? (0, import_jsx_runtime31.jsx)("a", { "aria-label": ariaLabel, "data-testid": "flowbite-footer-icon", href, className: (0, import_classnames27.default)(theme2.base, className), ...props, children: (0, import_jsx_runtime31.jsx)(Icon, { className: theme2.size }) }) : (0, import_jsx_runtime31.jsx)(Icon, { "data-testid": "flowbite-footer-icon", className: theme2.size, ...props }) });
};
...
var FooterLink = ({ as: Component = "a", children, className, href, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime32.jsx)("li", { className: (0, import_classnames28.default)(theme2.base, className), children: (0, import_jsx_runtime32.jsx)(Component, { href, className: theme2.href, ...props, children }) });
};
...
var FooterLinkGroup = ({ children, className, col = false, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime33.jsx)("ul", { "data-testid": "footer-groupLink", className: (0, import_classnames29.default)(theme2.base, col && theme2.col, className), ...props, children });
};
...
var FooterTitle = ({ as: Component = "h2", className, theme: customTheme = {}, title, ...props }) => {
  ...
  return (0, import_jsx_runtime34.jsx)(Component, { "data-testid": "flowbite-footer-title", className: (0, import_classnames30.default)(theme2.base, className), ...props, children: title });
};
...
var FooterComponent = ({ bgDark = false, children, className, container = false, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime35.jsx)("footer", { "data-testid": "flowbite-footer", className: (0, import_classnames31.default)(theme2.root.base, bgDark && theme2.root.bgDark, container && theme2.root.container, className), ...props, children });
};
...
var Label = ({ children, className, color = "default", disabled = false, theme: customTheme = {}, value, ...props }) => {
  ...
  return (0, import_jsx_runtime36.jsx)("label", { className: (0, import_classnames32.default)(theme2.root.base, theme2.root.colors[color], disabled ?? theme2.root.disabled, className), ...props, children: value ?? children ?? "" });
};
...
var ListGroupItem = ({ active: isActive, children, className, href, icon: Icon, onClick, theme: customTheme = {}, ...props }) => {
  ...
  const isLink = typeof href !== "undefined";
  const Component = isLink ? "a" : "button";
  return (0, import_jsx_runtime37.jsx)("li", { className: (0, import_classnames33.default)(theme2.base, className), children: (0, import_jsx_runtime37.jsxs)(Component, { href, onClick, type: isLink ? void 0 : "button", className: (0, import_classnames33.default)(theme2.link.active[isActive ? "on" : "off"], theme2.link.base, theme2.link.href[isLink ? "on" : "off"]), ...props, children: [Icon && (0, import_jsx_runtime37.jsx)(Icon, { "aria-hidden": true, "data-testid": "flowbite-list-group-item-icon", className: theme2.link.icon }), children] }) });
};
...
var ListGroupComponent = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime38.jsx)("ul", { className: (0, import_classnames34.default)(theme2.root.base, className), ...props, children });
};
...
var ModalFooter = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  const { popup } = useModalContext();
  return (0, import_jsx_runtime40.jsx)("div", { className: (0, import_classnames36.default)(theme2.base, {
    [theme2.popup]: !popup
  }, className), ...props, children });
};
...
var ModalHeader = ({ as: Component = "h3", children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime41.jsxs)("div", { className: (0, import_classnames37.default)(theme2.base, {
    [theme2.popup]: popup
  }, className), ...props, children: [(0, import_jsx_runtime41.jsx)(Component, { className: theme2.title, children }), (0, import_jsx_runtime41.jsx)("button", { "aria-label": "Close", className: theme2.close.base, type: "button", onClick: onClose, children: (0, import_jsx_runtime41.jsx)(HiOutlineX, { "aria-hidden": true, className: theme2.close.icon }) })] });
};
...
var ModalComponent = ({ children, className, dismissible = false, onClose, popup, position = "center", root, show, size: size2 = "2xl", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_react_dom4.createPortal)((0, import_jsx_runtime42.jsx)(ModalContext.Provider, { value: { popup, onClose }, children: (0, import_jsx_runtime42.jsx)("div", { "aria-hidden": !show, "data-testid": "modal", onClick: handleOnClick, role: "dialog", className: (0, import_classnames38.default)(theme2.root.base, theme2.root.positions[position], show ? theme2.root.show.on : theme2.root.show.off, className), ...props, children: (0, import_jsx_runtime42.jsx)("div", { className: (0, import_classnames38.default)(theme2.content.base, theme2.root.sizes[size2]), children: (0, import_jsx_runtime42.jsx)("div", { className: theme2.content.inner, children }) }) }) }), containerRef.current);
};
...
var NavbarBrand = ({ as: Component = "a", children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime43.jsx)(Component, { className: (0, import_classnames39.default)(theme2.base, className), ...props, children });
};
...
var NavbarCollapse = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime44.jsx)("div", { "data-testid": "flowbite-navbar-collapse", className: (0, import_classnames40.default)(theme2.base, theme2.hidden[!isOpen ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime44.jsx)("ul", { className: theme2.list, children }) });
};
...
var NavbarLink = ({ active, as: Component = "a", disabled, children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime45.jsx)("li", { children: (0, import_jsx_runtime45.jsx)(Component, { className: (0, import_classnames41.default)(theme2.base, {
...
var NavbarToggle = ({ barIcon: BarIcon = GoThreeBars, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime46.jsxs)("button", { "data-testid": "flowbite-navbar-toggle", onClick: handleClick, className: (0, import_classnames42.default)(theme2.base, className), ...props, children: [(0, import_jsx_runtime46.jsx)("span", { className: "sr-only", children: "Open main menu" }), (0, import_jsx_runtime46.jsx)(BarIcon, { "aria-hidden": true, className: theme2.icon })] });
};
...
var NavbarComponent = ({ border, children, className, fluid = false, menuOpen, rounded, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime47.jsx)(NavbarContext.Provider, { value: { isOpen, setIsOpen }, children: (0, import_jsx_runtime47.jsx)("nav", { className: (0, import_classnames43.default)(theme2.base, theme2.bordered[border ? "on" : "off"], theme2.rounded[rounded ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime47.jsx)("div", { className: (0, import_classnames43.default)(theme2.inner.base, theme2.inner.fluid[fluid ? "on" : "off"]), children }) }) });
};
...
var PaginationButton = ({ active, children, className, onClick, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime48.jsx)("button", { className: (0, import_classnames44.default)({
...
// node_modules/flowbite-react/lib/esm/components/Pagination/Pagination.js
var PaginationComponent = ({ className, currentPage, layout = "pagination", nextLabel = "Next", onPageChange, previousLabel = "Previous", renderPaginationButton = (props2) => (0, import_jsx_runtime49.jsx)(PaginationButton_default, { ...props2 }), showIcons: showIcon = false, theme: customTheme = {}, totalPages, ...props }) => {
  const theme2 = mergeDeep(useTheme().theme.pagination, customTheme);
  ...
  return (0, import_jsx_runtime49.jsxs)("nav", { className: (0, import_classnames45.default)(theme2.base, className), ...props, children: [layout === "table" && (0, import_jsx_runtime49.jsxs)("div", { className: theme2.layout.table.base, children: ["Showing ", (0, import_jsx_runtime49.jsx)("span", { className: theme2.layout.table.span, children: firstPage }), " to ", (0, import_jsx_runtime49.jsx)("span", { className: theme2.layout.table.span, children: lastPage }), " of ", (0, import_jsx_runtime49.jsx)("span", { className: theme2.layout.table.span, children: totalPages }), " Entries"] }), (0, import_jsx_runtime49.jsxs)("ul", { className: theme2.pages.base, children: [(0, import_jsx_runtime49.jsx)("li", { children: renderPaginationButton({
    className: (0, import_classnames45.default)((0, import_classnames45.default)(theme2.pages.previous.base, showIcon && theme2.pages.showIcon)),
    onClick: goToPreviousPage,
    children: (0, import_jsx_runtime49.jsxs)(import_jsx_runtime49.Fragment, { children: [showIcon && (0, import_jsx_runtime49.jsx)(HiChevronLeft, { "aria-hidden": true, className: theme2.pages.previous.icon }), previousLabel] })
  }) }), layout === "pagination" && range_default(firstPage, lastPage).map((page) => (0, import_jsx_runtime49.jsx)("li", { "aria-current": page === currentPage ? "page" : void 0, children: renderPaginationButton({
    className: (0, import_classnames45.default)(theme2.pages.selector.base, {
      [theme2.pages.selector.active]: currentPage === page
    }),
    active: page === currentPage,
    onClick: () => onPageChange(page),
    children: page
  }) }, page)), (0, import_jsx_runtime49.jsx)("li", { children: renderPaginationButton({
    className: (0, import_classnames45.default)(theme2.pages.next.base, showIcon && theme2.pages.showIcon),
    onClick: goToNextPage,
    children: (0, import_jsx_runtime49.jsxs)(import_jsx_runtime49.Fragment, { children: [nextLabel, showIcon && (0, import_jsx_runtime49.jsx)(HiChevronRight, { "aria-hidden": true, className: theme2.pages.next.icon })] })
  }) })] })] });
};
...
var Progress = ({ className, color = "blue", labelProgress = false, labelText = false, progress, progressLabelPosition = "inside", size: size2 = "md", textLabel = "progressbar", textLabelPosition = "inside", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime50.jsx)(import_jsx_runtime50.Fragment, { children: (0, import_jsx_runtime50.jsxs)("div", { id, "aria-label": textLabel, "aria-valuenow": progress, role: "progressbar", ...props, children: [(textLabel && labelText && textLabelPosition === "outside" || progress > 0 && labelProgress && progressLabelPosition === "outside") && (0, import_jsx_runtime50.jsxs)("div", { className: theme2.label, "data-testid": "flowbite-progress-outer-label-container", children: [textLabel && labelText && textLabelPosition === "outside" && (0, import_jsx_runtime50.jsx)("span", { "data-testid": "flowbite-progress-outer-text-label", children: textLabel }), labelProgress && progressLabelPosition === "outside" && (0, import_jsx_runtime50.jsxs)("span", { "data-testid": "flowbite-progress-outer-progress-label", children: [progress, "%"] })] }), (0, import_jsx_runtime50.jsx)("div", { className: (0, import_classnames46.default)(theme2.base, theme2.size[size2], className), children: (0, import_jsx_runtime50.jsxs)("div", { style: { width: `${progress}%` }, className: (0, import_classnames46.default)(theme2.bar, theme2.color[color], theme2.size[size2]), children: [textLabel && labelText && textLabelPosition === "inside" && (0, import_jsx_runtime50.jsx)("span", { "data-testid": "flowbite-progress-inner-text-label", children: textLabel }), progress > 0 && labelProgress && progressLabelPosition === "inside" && (0, import_jsx_runtime50.jsxs)("span", { "data-testid": "flowbite-progress-inner-progress-label", children: [progress, "%"] })] }) })] }) });
};
...
var Radio = (0, import_react28.forwardRef)(({ className, theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime51.jsx)("input", { ref, type: "radio", className: (0, import_classnames47.default)(theme2.root.base, className), ...props });
});
...
var RangeSlider = (0, import_react29.forwardRef)(({ className, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime52.jsx)(import_jsx_runtime52.Fragment, { children: (0, import_jsx_runtime52.jsx)("div", { "data-testid": "flowbite-range-slider", className: (0, import_classnames48.default)(theme2.root.base, className), children: (0, import_jsx_runtime52.jsx)("div", { className: theme2.field.base, children: (0, import_jsx_runtime52.jsx)("input", { ref, type: "range", className: (0, import_classnames48.default)(theme2.field.input.base, theme2.field.input.sizes[sizing]), ...props }) }) }) });
});
...
var RatingAdvanced = ({ children, className, percentFilled = 0, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime53.jsxs)("div", { className: (0, import_classnames49.default)(theme2.base, className), ...props, children: [(0, import_jsx_runtime53.jsx)("span", { className: theme2.label, children }), (0, import_jsx_runtime53.jsx)("div", { className: theme2.progress.base, children: (0, import_jsx_runtime53.jsx)("div", { className: theme2.progress.fill, "data-testid": "flowbite-rating-fill", style: { width: `${percentFilled}%` } }) }), (0, import_jsx_runtime53.jsx)("span", { className: theme2.progress.label, children: `${percentFilled}%` })] });
};
...
var RatingStar = ({ className, filled = true, starIcon: Icon = HiStar, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime54.jsx)(Icon, { "data-testid": "flowbite-rating-star", className: (0, import_classnames50.default)(theme2.sizes[size2], theme2[filled ? "filled" : "empty"], className), ...props });
};
...
var RatingComponent = ({ children, className, size: size2 = "sm", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime55.jsx)(RatingContext.Provider, { value: { size: size2 }, children: (0, import_jsx_runtime55.jsx)("div", { className: (0, import_classnames51.default)(theme2.root.base, className), ...props, children }) });
};
...
var Select = (0, import_react31.forwardRef)(({ addon, children, className, color = "gray", helperText, icon: Icon, shadow, sizing = "md", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime56.jsxs)("div", { className: (0, import_classnames52.default)(theme2.base, className), children: [addon && (0, import_jsx_runtime56.jsx)("span", { className: theme2.addon, children: addon }), (0, import_jsx_runtime56.jsxs)("div", { className: theme2.field.base, children: [Icon && (0, import_jsx_runtime56.jsx)("div", { className: theme2.field.icon.base, children: (0, import_jsx_runtime56.jsx)(Icon, { className: theme2.field.icon.svg }) }), (0, import_jsx_runtime56.jsx)("select", { className: (0, import_classnames52.default)(theme2.field.select.base, theme2.field.select.colors[color], theme2.field.select.withIcon[Icon ? "on" : "off"], theme2.field.select.withAddon[addon ? "on" : "off"], theme2.field.select.withShadow[shadow ? "on" : "off"], theme2.field.select.sizes[sizing]), ...props, ref, children }), helperText && (0, import_jsx_runtime56.jsx)(HelperText, { color, children: helperText })] })] });
});
...
var Tooltip = ({ animation = "duration-300", arrow: arrow3 = true, children, className, content, placement = "top", style = "dark", theme: customTheme = {}, trigger = "hover", ...props }) => {
  ...
  return (0, import_jsx_runtime57.jsx)(Floating, { animation, arrow: arrow3, content, placement, style, theme: theme2, trigger, className, ...props, children });
};
...
var SidebarCollapse = ({ children, className, icon: Icon, label, open = false, theme: customTheme = {}, ...props }) => {
  ...
  const Wrapper = ({ children: children2 }) => (0, import_jsx_runtime58.jsx)("li", { children: isCollapsed && !isOpen ? (0, import_jsx_runtime58.jsx)(Tooltip, { content: label, placement: "right", children: children2 }) : children2 });
  return (0, import_jsx_runtime58.jsxs)(Wrapper, { children: [(0, import_jsx_runtime58.jsxs)("button", { id: `flowbite-sidebar-collapse-${id}`, onClick: () => setOpen(!isOpen), title: label, type: "button", className: (0, import_classnames53.default)(theme2.button, className), ...props, children: [Icon && (0, import_jsx_runtime58.jsx)(Icon, { "aria-hidden": true, "data-testid": "flowbite-sidebar-collapse-icon", className: (0, import_classnames53.default)(theme2.icon.base, theme2.icon.open[isOpen ? "on" : "off"]) }), isCollapsed ? (0, import_jsx_runtime58.jsx)("span", { className: "sr-only", children: label }) : (0, import_jsx_runtime58.jsxs)(import_jsx_runtime58.Fragment, { children: [(0, import_jsx_runtime58.jsx)("span", { "data-testid": "flowbite-sidebar-collapse-label", className: theme2.label.base, children: label }), (0, import_jsx_runtime58.jsx)(HiChevronDown, { "aria-hidden": true, className: theme2.label.icon })] })] }), (0, import_jsx_runtime58.jsx)("ul", { "aria-labelledby": `flowbite-sidebar-collapse-${id}`, hidden: !isOpen, className: theme2.list, children: (0, import_jsx_runtime58.jsx)(SidebarItemContext.Provider, { value: { isInsideCollapse: true }, children }) })] });
};
...
var SidebarCTA = ({ children, color = "info", className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime59.jsx)("div", { "data-testid": "sidebar-cta", hidden: isCollapsed, className: (0, import_classnames54.default)(theme2.base, theme2.color[color], className), ...props, children });
};
...
var ListItem = ({ id, isCollapsed, tooltipChildren, children: wrapperChildren }) => (0, import_jsx_runtime60.jsx)("li", { children: isCollapsed ? (0, import_jsx_runtime60.jsx)(Tooltip, { content: (0, import_jsx_runtime60.jsx)(TooltipContent, { id, children: tooltipChildren }), placement: "right", children: wrapperChildren }) : wrapperChildren });
var TooltipContent = ({ id, children }) => (0, import_jsx_runtime60.jsx)(Children5, { id, children });
var Children5 = ({ id, children }) => {
  const theme2 = useTheme().theme.sidebar.item;
  return (0, import_jsx_runtime60.jsx)("span", { "data-testid": "flowbite-sidebar-item-content", id: `flowbite-sidebar-item-${id}`, className: (0, import_classnames55.default)(theme2.content.base), children });
};
var SidebarItem = (0, import_react35.forwardRef)(({ active: isActive, as: Component = "a", children, className, icon: Icon, label, labelColor = "info", theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime60.jsx)(ListItem, { id, isCollapsed, tooltipChildren: children, children: (0, import_jsx_runtime60.jsxs)(Component, { "aria-labelledby": `flowbite-sidebar-item-${id}`, ref, className: (0, import_classnames55.default)(theme2.base, isActive && theme2.active, !isCollapsed && isInsideCollapse && ((_a = theme2.collapsed) == null ? void 0 : _a.insideCollapse), className), ...props, children: [Icon && (0, import_jsx_runtime60.jsx)(Icon, { "aria-hidden": true, "data-testid": "flowbite-sidebar-item-icon", className: (0, import_classnames55.default)((_b = theme2.icon) == null ? void 0 : _b.base, isActive && ((_c = theme2.icon) == null ? void 0 : _c.active)) }), isCollapsed && !Icon && (0, import_jsx_runtime60.jsx)("span", { className: (_d = theme2.collapsed) == null ? void 0 : _d.noIcon, children: children.charAt(0).toLocaleUpperCase() ?? "?" }), !isCollapsed && (0, import_jsx_runtime60.jsx)(Children5, { id, children }), !isCollapsed && label && (0, import_jsx_runtime60.jsx)(Badge, { color: labelColor, "data-testid": "flowbite-sidebar-label", hidden: isCollapsed, className: theme2.label, children: label })] }) });
});
...
var SidebarItemGroup = ({ children, className, ...props }) => {
  ...
  return (0, import_jsx_runtime61.jsx)("ul", { "data-testid": "flowbite-sidebar-item-group", className: (0, import_classnames56.default)(theme2, className), ...props, children: (0, import_jsx_runtime61.jsx)(SidebarItemContext.Provider, { value: { isInsideCollapse: false }, children }) });
};
...
var SidebarItems = ({ children, className, ...props }) => {
  ...
  return (0, import_jsx_runtime62.jsx)("div", { className: (0, import_classnames57.default)(theme2, className), "data-testid": "flowbite-sidebar-items", ...props, children });
};
...
var SidebarLogo = ({ children, className, href, img, imgAlt = "", theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime63.jsxs)("a", { "aria-labelledby": `flowbite-sidebar-logo-${id}`, href, className: (0, import_classnames58.default)(theme2.base, className), ...props, children: [(0, import_jsx_runtime63.jsx)("img", { alt: imgAlt, src: img, className: theme2.img }), (0, import_jsx_runtime63.jsx)("span", { className: theme2.collapsed[isCollapsed ? "on" : "off"], id: `flowbite-sidebar-logo-${id}`, children })] });
};
...
var SidebarComponent = ({ children, as: Component = "nav", collapseBehavior = "collapse", collapsed: isCollapsed = false, theme: customTheme = {}, className, ...props }) => {
  ...
  return (0, import_jsx_runtime64.jsx)(SidebarContext.Provider, { value: { isCollapsed }, children: (0, import_jsx_runtime64.jsx)(Component, { "aria-label": "Sidebar", hidden: isCollapsed && collapseBehavior === "hide", className: (0, import_classnames59.default)(theme2.root.base, theme2.root.collapsed[isCollapsed ? "on" : "off"], className), ...props, children: (0, import_jsx_runtime64.jsx)("div", { className: theme2.root.inner, children }) }) });
};
...
var TabsComponent = (0, import_react37.forwardRef)(({ children, className, onActiveTabChange, style = "default", theme: customTheme = {}, ...props }, ref) => {
  ...
  const [focusedTab, setFocusedTab] = (0, import_react37.useState)(-1);
...
var TableBody = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime67.jsx)("tbody", { className: (0, import_classnames61.default)(theme2.base, className), ...props, children });
};
...
var TableCell = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime68.jsx)("td", { className: (0, import_classnames62.default)(theme2.base, className), ...props, children });
};
...
var TableHead = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime69.jsx)("thead", { className: (0, import_classnames63.default)(theme2.head.base, className), ...props, children: (0, import_jsx_runtime69.jsx)("tr", { children }) });
};
...
var TableHeadCell = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime70.jsx)("th", { className: (0, import_classnames64.default)(theme2.base, className), ...props, children });
};
...
var TableRow = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime71.jsx)("tr", { "data-testid": "table-row-element", className: (0, import_classnames65.default)(theme2.base, striped && theme2.striped, hoverable && theme2.hovered, className), ...props, children });
};

// node_modules/flowbite-react/lib/esm/components/Table/Table.js
var TableComponent = ({ children, className, hoverable, striped, theme: customTheme = {}, ...props }) => {
  const theme2 = mergeDeep(useTheme().theme.table, customTheme);
  return (0, import_jsx_runtime72.jsx)("div", { "data-testid": "table-element", className: (0, import_classnames66.default)(theme2.root.wrapper), children: (0, import_jsx_runtime72.jsxs)(TableContext.Provider, { value: { striped, hoverable }, children: [(0, import_jsx_runtime72.jsx)("div", { className: (0, import_classnames66.default)(theme2.root.shadow, className) }), (0, import_jsx_runtime72.jsx)("table", { className: (0, import_classnames66.default)(theme2.root.base, className), ...props, children })] }) });
};
...
var Textarea = (0, import_react39.forwardRef)(({ className, color = "gray", helperText, shadow, theme: customTheme = {}, ...props }, ref) => {
  ...
  return (0, import_jsx_runtime73.jsxs)(import_jsx_runtime73.Fragment, { children: [(0, import_jsx_runtime73.jsx)("textarea", { ref, className: (0, import_classnames67.default)(theme2.base, theme2.colors[color], theme2.withShadow[shadow ? "on" : "off"], className), ...props }), helperText && (0, import_jsx_runtime73.jsx)(HelperText, { color, children: helperText })] });
});
...
var TimelineBody = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime75.jsx)("div", { className: (0, import_classnames69.default)(theme2, className), ...props, children });
};
...
var TimelineContent = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime76.jsx)("div", { "data-testid": "timeline-content", className: (0, import_classnames70.default)(horizontal && theme2.root.base, className), ...props, children });
};
...
var TimelineItem = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  const { horizontal } = useTimelineContext();
  return (0, import_jsx_runtime77.jsx)("li", { "data-testid": "timeline-item", className: (0, import_classnames71.default)(horizontal && theme2.root.horizontal, !horizontal && theme2.root.vertical, className), ...props, children });
};
...
var TimelinePoint = ({ children, className, icon: Icon, theme: customTheme = {}, ...props }) => {
  ...
  const { horizontal } = useTimelineContext();
  return (0, import_jsx_runtime78.jsxs)("div", { "data-testid": "timeline-point", className: (0, import_classnames72.default)(horizontal && theme2.horizontal, !horizontal && theme2.vertical, className), ...props, children: [children, Icon ? (0, import_jsx_runtime78.jsx)("span", { className: (0, import_classnames72.default)(theme2.marker.icon.wrapper), children: (0, import_jsx_runtime78.jsx)(Icon, { "aria-hidden": true, className: (0, import_classnames72.default)(theme2.marker.icon.base) }) }) : (0, import_jsx_runtime78.jsx)("div", { className: (0, import_classnames72.default)(horizontal && theme2.marker.base.horizontal, !horizontal && theme2.marker.base.vertical) }), horizontal && (0, import_jsx_runtime78.jsx)("div", { className: (0, import_classnames72.default)(theme2.line) })] });
};
...
var TimelineTime = ({ children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime79.jsx)("time", { className: (0, import_classnames73.default)(theme2, className), ...props, children });
};
...
var TimelineTitle = ({ as: Tag = "h3", children, className, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime80.jsx)(Tag, { className: (0, import_classnames74.default)(theme2, className), ...props, children });
};
...
var TimelineComponent = ({ children, className, horizontal, theme: customTheme = {}, ...props }) => {
  ...
  return (0, import_jsx_runtime81.jsx)(TimelineContext.Provider, { value: { horizontal }, children: (0, import_jsx_runtime81.jsx)("ol", { "data-testid": "timeline-component", className: (0, import_classnames75.default)(horizontal && theme2.root.direction.horizontal, !horizontal && theme2.root.direction.vertical, className), ...props, children }) });
};
...
var ToastToggle = ({ className, onClick, theme: customTheme = {}, xIcon: XIcon = HiX, ...props }) => {
  ...
  return (0, import_jsx_runtime82.jsx)("button", { "aria-label": "Close", onClick: handleClick, type: "button", className: (0, import_classnames76.default)(theme2.base, className), ...props, children: (0, import_jsx_runtime82.jsx)(XIcon, { "aria-hidden": true, className: theme2.icon }) });
};
