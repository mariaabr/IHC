                ...
                <div className="flex items-center ml-5">
                  ...
                  <form onSubmit={handleModalSubmit}>
                    ...
                    >
                      ...
                      <button
                        type="submit"
                        className="relative bg-[#5BB6AE] hover:bg-[#037971] text-white py-4 px-14 rounded-xl mt-5 "
                      ...
                      <button
                        type="submit"
                        className="relative bg-[#595959] hover:bg-[#0b0b0b] text-white py-4 px-14 rounded-xl mt-5 ml-5"
