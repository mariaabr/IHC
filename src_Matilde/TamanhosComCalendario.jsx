                ...
                <div className="flex items-center ml-5">
                  <form onSubmit={handleModalSubmit}>
                    ...
                    >
                      ...
                      <button
                        type="submit"
                        className="relative bg-[#595959] hover:bg-[#0b0b0b] text-white py-4 px-14 rounded-xl mt-5 ml-5 mt-15 mb-0"
                      ...
                      <button
                        type="submit"
                        className="relative bg-[#5BB6AE] hover:bg-[#037971] text-white py-4 px-14 rounded-xl mt-5 mt-15 mb-0 ml-4"
                        onClick={OpenText2}
                      >
          ...
          {showText3 && (
            <div className=" fixed top-0 left-0 right-0 bottom-0 flex items-center justify-center">
              <div className="rounded-xl max-w-xl text-left absolute z-10 bg-gray-100 rounded-md pt-20 pl-14 pr-24 pb-20 flex flex-col items-start ">
                ...
                <h4 className="flex font-bold text-3xl"style={{ color:"green", display: 'flex', justifyContent: 'center', alignItems: 'center', margin: '0 auto' }}>
                  Aula marcada!
                </h4>
                <div className="flex items-center ml-5">
                  <div
